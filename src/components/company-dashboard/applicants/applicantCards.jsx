...
class ApplicantCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: null,          // null | "interview" | "offer" | "joining"
      pendingStatus: null,  // which status we're confirming
      interviewDay: "",
      interviewTime: "",
      offerDate: "",
      offeredSalary: "",
...
confirmInterview = () => {
  ...
  render() {
    const { candidate } = this.props;
    const { modal, interviewDay, interviewTime, offerDate, offeredSalary, joiningDate } = this.state;
      ...
      <div style={{ fontSize: "11px", color: "#718096", marginTop: "4px" }}>
        ...
        {modal === "interview" && (
          <ModalWrapper title="📅 Schedule Interview" onClose={this.closeModal}>
            ...
            <input type="time" className="form-control mb-4"
              value={interviewTime}
