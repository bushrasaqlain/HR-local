...
activeTab: "Interview_Scheduled",
  ...
  render() {
    ...
    return (
      <>
        <Head>
          <title>Interview_Scheduled Candidates</title>
...
<div style={{
  ...
  {[
    ...
    <button
      ...
      style={{
        flex: 1,
        padding: isMobile ? "0.5rem 0.5rem" : "0.7rem 1.2rem",
        border: "none",
        borderRadius: "8px",
        fontWeight: 600,
        ...
        cursor: "pointer",
        transition: "all 0.3s ease",
        background: this.state.activeTab === tab.value
          ? "linear-gradient(135deg, #667eea 0%, #764ba2 100%)"
          : "transparent",
        color: this.state.activeTab === tab.value ? "white" : "#4a5568",
        display: "flex",
        alignItems: "center",
                                  ...
                                  >
                                    ...
                                    <td className="text-center">
                                      <span className={`status-badge ${candidate.candidateStatus === "Pending" ? "status-pending" :
                                        ...
                                        {candidate.candidateStatus || "Interview_Scheduled"}
                                      </span>
                                    </td>
  ...
  <>
    <td className="text-center">
      {candidate.candidateStatus === "Interview_Conducted" ? (
        <span style={{
        ...
        <span className="response-badge response-accepted">Accepted</span>
      ) : candidate.candidate_response === "Reschedule Requested" ? (
        <div className="d-flex flex-column align-items-center">
          <span className="response-badge response-reschedule mb-1">Reschedule</span>
          {!isMobile && (
        ...
        <span className="badge bg-secondary">{candidate.candidate_response}</span>
      ) : (
      ...
      <div className="d-flex gap-2 justify-content-center">
        {candidate.candidateStatus === "Interview_Conducted" ? (
          <button
            ...
            onClick={(e) => { e.stopPropagation(); this.openCandidateMessage(candidate); }}
          ...
          <>
            {candidate.candidate_response === "Reschedule Requested" && (
              ...
              >
                {isMobile ? "✓" : <><i className="bi bi-check-circle me-1"></i>Confirm</>}
              </button>
            )}
            {(candidate.candidate_response === "Accepted" ||
              candidate.candidate_response === "Confirmed" ||
