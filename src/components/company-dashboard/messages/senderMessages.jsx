...
class SenderMessages extends Component {
  constructor(props) {
    ...
    this.messagesContainerRef = createRef(); // Add ref for messages container
  ...
  componentDidMount() {
    console.log("SenderMessages mounted with props:", this.props);
    this.fetchMessages();
  ...
  handleSendMessage = async (e) => {
    ...
    try {
      // Send to the message endpoint, NOT updatestatus
          ...
          <CardFooter className="p-3 bg-dark-subtle" style={{ width: "100%" }}>
            <Form onSubmit={this.handleSendMessage} style={{ width: "100%" }}>
              <div className="d-flex w-100 gap-2">
                <Input
                  type="textarea"
                  className="flex-grow-1" // Fixed: changed from "flex-grow" to "flex-grow-1"
