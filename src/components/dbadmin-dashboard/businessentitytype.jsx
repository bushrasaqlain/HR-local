...
class BusinessEntityTypes extends Component {
  ...
  handleExcelExport = () => {
    ...
    // Map data for Excel
    const dataToExport = businesstype.map((businesstypes) => ({
      "Name": businesstypes.name,
      "Status": businesstypes.status,
      "Created At": this.formatDate(businesstypes.created_at),
      "Updated At": this.formatDate(businesstypes.updated_at),
    }));
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "businesstype");
  ...
  handleExcelImport = async (e) => {
    ...
    try {
      ...
      reader.onload = async (evt) => {
        ...
        await api.post(`${this.apiBaseUrl}addbusinesstype`, {
          type: "csv",
          data: formattedData,
          userId,
        });
