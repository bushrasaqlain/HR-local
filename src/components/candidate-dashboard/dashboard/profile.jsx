                    ...
                    <div style={{
                      ...
                      {this.state.searchTerm && (
                        <span
                          ...
                          style={{ cursor: "pointer", color: "#9ca3af", fontWeight: "bold", marginLeft: "8px" }}
                        >
                          ✕
                        </span>
                      )}
...
>>>>>>> 1983a23c56f72e8a344103e55485c8eb2d6160b0
                        </div>
                      )}
                    </CardBody>
                  </Card>
            ...
            <div className="row g-3">
              ...
              <div className="col-12 mb-5">
                <Card className="text-center justify-content-center p-3">
                  ...
                  <span className="badge mb-3" style={{ background: "#5F8190" }}>
