      ...
      Rejected: {
        ...
        bodyHtml: `
          ...
          <div style="background:#fff3cd;border:1px solid #ffc107;border-radius:6px;padding:15px;margin:20px 0;">
            <p style="margin:0;color:#856404;font-size:14px;">💡 <strong>Tip:</strong> Keep your profile updated to get noticed by more employers on Superio.</p>
          </div>
...
Best of luck!/p>
    ...
    await transporter.sendMail({
      from: `"${company_name} via Superio" <${process.env.EMAIL_USER}>`,
      to: email,
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
          ...
          <p style="text-align:center;font-size:12px;color:#aaa;margin-top:15px;">Sent via Superio Job Portal</p>
        </div>
      `,
    });
  ...
  // ── Availability / Working Hours (10pts) ──    ← ADD FROM HERE
      ...
      const finalCandidates = tieredCandidates.map((c) => {
        ...
        const isShortlistedOrApproved = ["Interview_Scheduled","Interview_Conducted","Shortlisted","Considered","Offered","Selected","Joined"].includes(c.candidateStatus);
